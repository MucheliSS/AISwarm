...
SWARM_AGENTS = [
    {
        ...
        'icon': '🧠',
        'model': 'anthropic/claude-sonnet-4.5-20250514',  # Claude Sonnet 4.5 - Best reasoning
    ...
    },
    {
        ...
        'icon': '👨‍⚕️',
        'model': 'google/gemini-3.0-flash-preview',  # Gemini 3 Flash - Fast, practical
    ...
    },
    {
        ...
        'icon': '💻',
        'model': 'anthropic/claude-sonnet-4.5-20250514',  # Claude Sonnet 4.5 - Innovation
    ...
    },
    {
        ...
        'icon': '🌍',
        'model': 'zhipuai/glm-4.7',  # GLM 4.7 - Chinese model for global perspective
...
SYNTHESIS_MODEL = 'anthropic/claude-sonnet-4.5-20250514'
